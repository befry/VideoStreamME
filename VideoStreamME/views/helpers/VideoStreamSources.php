...
class VideoStream_View_Helper_VideoStreamSources extends Zend_View_Helper_Abstract
{
    ...
    public function videoStreamSources($item = null)
    {
        ...
        $sources = array();
        if (get_option('videostream_mediaelement_flash_streaming')) {
        ...
        if (get_option('videostream_mediaelement_http_streaming')) {
        ...
        if (get_option('videostream_mediaelement_hls_streaming')) {
