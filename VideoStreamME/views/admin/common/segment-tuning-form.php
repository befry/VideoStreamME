...
<?php // Query("input[]") on array, button click must wrap in document ready. ?>
    ...
    <script type="text/javascript">
        ...
        mediaelement("mediaelement_plugin").onReady(function() {
            mediaelement("mediaelement_plugin").seek(calculateTime(<?php echo json_encode($segment_start); ?>));
            jQuery("#CurrentPos").val(getFormattedTimeString(<?php echo json_encode($segment_end); ?>));
            mediaelement("mediaelement_plugin").pause();
        });

        mediaelement("mediaelement_plugin").onTime(function() {
            jQuery("#CurrentPos").val(getFormattedTimeString(mediaelement("mediaelement_plugin").getPosition()));
        });
    </script>
    <p>
            ...
            <script type="text/javascript">
                jQuery(document).ready(function() {
                    ...
                    jQuery("startButton").click(function() {
                        jQuery("#SegmentStart").val(getFormattedTimeString(mediaelement().getPosition()));
                    ...
                    jQuery("endButton").click(function() {
                        jQuery("#SegmentEnd").val(getFormattedTimeString(mediaelement().getPosition()));
