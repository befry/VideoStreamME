<fieldset id="fieldset-videostream-public-theme"><legend><?php echo __('Public Theme'); ?></legend>
    ...
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('videostream_mediaelement_width_public',
                __('Viewer Width')); ?>
        </div>
        <div class='inputs five columns omega'>
            <?php echo $this->formText('videostream_mediaelement_width_public', get_option('videostream_mediaelement_width_public'), array('size' => 5)); ?>
            <p class="explanation">
    ...
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('videostream_mediaelement_height_public',
                __('Viewer Height')); ?>
        </div>
        <div class='inputs five columns omega'>
            <?php echo $this->formText('videostream_mediaelement_height_public', get_option('videostream_mediaelement_height_public'), array('size' => 5)); ?>
            <p class="explanation">
    ...
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('videostream_mediaelement_external_control',
                __('Use External Controls')); ?>
        </div>
        <div class='inputs five columns omega'>
            <p>
                <?php echo $this->formCheckbox('videostream_mediaelement_external_control', true,
                    array('checked' => (boolean) get_option('videostream_mediaelement_external_control'))); ?>
                <?php echo __('Display Specific Segment Using External Controls'); ?>
            </p>
            <p class="explanation">
                <?php echo __('Whether the ME Player plugin should use external controls instead of the builtin player controls.'); ?>
    ...
    <div class="field">
        ...
        <div class='inputs five columns omega'>
            ...
            <p class="explanation">
                <?php echo __('Whether the ME Player plugin should display information about the current video segment.'); ?>
    ...
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('videostream_mediaelement_autostart',
                __('Autostart Video')); ?>
        </div>
        <div class='inputs five columns omega'>
            <p>
                <?php echo $this->formCheckbox('videostream_mediaelement_autostart', true,
                    array('checked' => (boolean) get_option('videostream_mediaelement_autostart'))); ?>
                <?php echo __('Should the video start playing when the page is loaded'); ?>
            </p>
            <p class="explanation">
                <?php echo __('Whether the ME Player plugin should automatically start playing the current video segment when the page loads.'); ?>
            </p>
        </div>
    </div>
    <div class="field">
        <div class="two columns alpha">
            <?php echo $this->formLabel('videostream_mediaelement_streaming_protocols',
                __('Streaming Protocols')); ?>
        </div>
        <div class='inputs five columns omega'>
            <ul style="list-style-type: none;">
                <li>
                    <?php echo $this->formCheckbox('videostream_mediaelement_flash_streaming', true,
                        array('checked' => (boolean) get_option('videostream_mediaelement_flash_streaming'))); ?>
                    <?php echo __('Flash Streaming'); ?>
                </li>
                <li>
                    <?php echo $this->formCheckbox('videostream_mediaelement_flash_primary', true,
                        array('checked' => (boolean) get_option('videostream_mediaelement_flash_primary'))); ?>
                    <?php echo __('Use flash if possible'); ?>
                </li>
                <li>
                    <?php echo $this->formCheckbox('videostream_mediaelement_http_streaming', true,
                        array('checked' => (boolean) get_option('videostream_mediaelement_http_streaming'))); ?>
                    <?php echo __('HTTP Streaming'); ?>
                </li>
                <li>
                    <?php echo $this->formCheckbox('videostream_mediaelement_hls_streaming', true,
                        array('checked' => (boolean) get_option('videostream_mediaelement_hls_streaming'))); ?>
